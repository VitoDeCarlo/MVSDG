...
(function () {
	...
	WinJS.Navigation.onnavigating = function (evt) {
	    var navHost = document.body.querySelector("#navbar");
	    navHost.winControl.hide();
	}

	WinJS.Navigation.onnavigated = function (evt) {
	    var contentHost =
            document.body.querySelector("#pageContent"),
